...
const char* aioUsername = "your-adafruit-io-username";
const char* aioKey = "your-adafruit-io-key";
const char* mqttServer = "io.adafruit.com";
const int mqttPort = 1883;

const char* soilStatusTopic = "your-adafruit-io-username/feeds/soil-status";
const char* temperatureTopic = "your-adafruit-io-username/feeds/plant-temperature";
const char* humidityTopic = "your-adafruit-io-username/feeds/plant-humidity";
const char* moistureTopic = "your-adafruit-io-username/feeds/plant-moisture";
const char* lastWateredTopic = "your-adafruit-io-username/feeds/last-watered";
const char* pumpControlTopic = "your-adafruit-io-username/feeds/pump-control";
...
void loop() {
  ...
  publishToMQTT(soilmoisture == 1 ? "Dry" : "Wet", temperature, humidity, soilmoisture);

  // Check watering schedule (example: water twice a day)
  if ((now.hour() == 9 || now.hour() == 15) && soilmoisture == 1) {
